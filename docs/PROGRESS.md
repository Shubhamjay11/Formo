...
- Working on: —
- Last completed: 002-workspaces T2 — invite create/revoke/accept service + actions
- Known issues:
...
- Next up: 002-workspaces T3 — Invite email (Resend template)

## Feature status
| Spec | Phase | Status |
|---|---|---|
| 001-auth | A | T1–T3, T5–T6 done; T4 pages shipped, checkbox open (EMAIL_EXISTS Known issue) |
| 002-workspaces | A | T1–T2 done; T3–T6 open |
