...
- Working on: —
- Last completed: 002-workspaces T5 — Accept-invite page + logged-out → auth → return flow
- Known issues:
...
- Next up: 002-workspaces T6 — e2e/invites.spec.ts full loop + mismatch case

## Feature status
| Spec | Phase | Status |
|---|---|---|
| 001-auth | A | T1–T3, T5–T6 done; T4 pages shipped, checkbox open (EMAIL_EXISTS Known issue) |
| 002-workspaces | A | T1–T5 done; T6 open |
