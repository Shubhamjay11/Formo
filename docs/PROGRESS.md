...
- Working on: —
- Last completed: 002-workspaces T1 — invites/audit schema + migration + withOrg()/requireRole()
- Known issues:
...
- Next up: 002-workspaces T2 — Invite service + actions

## Feature status
| Spec | Phase | Status |
|---|---|---|
| 001-auth | A | T1–T3, T5–T6 done; T4 pages shipped, checkbox open (EMAIL_EXISTS Known issue) |
| 002-workspaces | A | T1 done; T2–T6 open |
